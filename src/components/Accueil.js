      ...
      <div className="div-main-program">
        ...
        <div className="program-flex">
          <div className="program">
            ...
            <h3>Un seul Dieu</h3>
            <p>Souverain, Tout Puissant et Sage. Créateur des choses visibles et invisibles.</p>
          </div>
          <div className="program">
            <i>
            ...
            <h3>Jésus Christ</h3>
            <p>Fils unique du Père qu&apos;il nous a fait connaître, vrai Dieu et vrai Homme.</p>
          </div>
          <div className="program">
            <i>
          ...
          <div className="program">
            ...
            <h3>La Bible</h3>
            <p>Composée des écrits canoniques de l&apos;Ancien et Nouveau Testament. (66 livres)</p>
          </div>
          <div className="program">
            <i>
